...
class TestRegisterUser:
    ...
    def test_register_user_success(self, client):
        ...
        response = client.post(
            self.registration_url, self.good_registration_credentials
        )
    ...
    def test_register_user_passwords_mismatch(self, client):
        ...
        expected_response = {
            "non_field_errors": [
                ErrorDetail(string="Entered passwords mismatched", code="invalid")
            ]
        }
    ...
    def test_register_user_without_confirmed_password(self, client):
        ...
        expected_response = {"confirmed_password": ["This field is required."]}
    ...
    def test_register_user_too_long_username(self, client):
        bad_credentials = self.good_registration_credentials
        long_username = (
            "FvM4sgubtxXwelCTl1LHrb3lUrpGIpnBgDVQxnIfcK6EUyXYC"
        ...
        assert response.data == {
            "username": [
                ErrorDetail(
                    string="Ensure this field has no more than 150 characters.",
                    code="max_length",
                )
            ]
        }
