...
class TestLoginUser:
    ...
    def test_login_user_wrong_password(self, client):
        ...
        expected_response = {'detail': ErrorDetail(string='No active account found with the given credentials',
    ...
    def test_login_user_without_username(self, client):
        ...
        response = client.post(self.login_url, bad_credentials)
        expected_response = [ErrorDetail(string='This field is required.', code='required')]
    ...
    def test_login_user_empty_username(self, client):
        ...
        response = client.post(self.login_url, bad_credentials)
        expected_response = [ErrorDetail(string='This field may not be blank.', code='blank')]
